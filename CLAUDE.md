...
| Authored content | `content/` | `graph_registry.py` (6 node + 17 edge built-in types) · `art_styles.py` (3 image looks: `painted` `anime` `photoreal`) + `stats/*.md` (`health` `patience` `suspicion` `trust`) |
