...
This plan completes four independent, already-scaffolded-but-unfinished seams in Velora. Each is self-contained and lands as its own phase set with commit-per-phase discipline (Velora git workflow). The four features:
