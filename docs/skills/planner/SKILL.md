---
name: planner
description: Use this skill when the user asks to create, refine, or evaluate an implementation plan, roadmap, migration plan, or structured sequence of work before coding in Mytheca. Plans are detailed, phase-by-phase, commit-per-phase, and validated with pytest + frontend tests.
---

# Plan Creation (Mytheca)

Use this skill to produce explicit, hierarchical, phase-by-phase implementation plans for Mytheca work. Save plans under `docs/plans/`.
