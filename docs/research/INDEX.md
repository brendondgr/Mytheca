...
| EXP-2026-08-015 | 2026-08-24 | <one line, specific enough to read in a table> | `planned` | <metric name, matching a key in values> (pending) | — | [EXP-2026-08-015-pov-and-voice-baseline](experiments/EXP-2026-08-015-pov-and-voice-baseline/) |
| EXP-2026-08-016 | 2026-08-24 | <one line, specific enough to read in a table> | `planned` | <metric name, matching a key in values> (pending) | — | [EXP-2026-08-016-continuous-scene-script](experiments/EXP-2026-08-016-continuous-scene-script/) |
| EXP-2026-08-017 | 2026-08-26 | Bound upfront plan — two execution arms (continuous vs per-beat) over one plan | `complete` | voiced_plan_adherence = 0.916667 ± 0.589255 (n=2) | — | [EXP-2026-08-017-bound-plan-execution](experiments/EXP-2026-08-017-bound-plan-execution/) |
| EXP-2026-08-018 | 2026-08-29 | Narrative style instructions (romance) in the cached prefix — before/after on the local model | `complete` | romance.proximity_per_1k = 9.623 ± 3.41043 (n=6) | — | [EXP-2026-08-018-narrative-style-romance](experiments/EXP-2026-08-018-narrative-style-romance/) |
