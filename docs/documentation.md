...
| **Scenario** | The live situation being played. | `id, storyline_id, title, genre, tone, goal, setting_id, opening, cast_ids, branches, position, max_turns, suggestions_count, context_beats, prompt_overrides, image, scene_art_positive, scene_art_negative` |
...
**Validation baseline:** 889 backend pytest cases and 628 Vitest cases across 90 co-located frontend test files, all passing.
