...
- Take the room you need, within a HARD LIMIT of 200 words. Count them. One to three short paragraphs; a whole paragraph of interiority before you speak is fine, and so is a beat with no spoken words at all if the moment calls for action or silence. You are not limited to a single line — but you are not writing a chapter either. Stop when the beat has landed.
