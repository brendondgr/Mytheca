...
_CHARACTERS: list[dict] = [
    {"id": "maerin", "name": "Maerin Voss", "role": "Antagonist", "color": "#8E2B1C", "mono": "MV", "traits": "Patient · Calculating · Velvet-tongued", "speech": "Measured and courteous; never raises her voice.", "goal": "Keep the salt routes hidden a little longer.", "secret": "She answers to the Drowned Court.", "appearance": "Tall and composed, in salt-faded indigo; silver at the temples, ink-stained fingers, eyes the grey of harbor fog.", "background": "Raised in the counting-houses of the upper town, Maerin rose through the salt guild on ledgers rather than blades, and now fronts the Drowned Court's trade while pretending the harbor still answers to law.", "personality": "Outwardly gracious and unhurried, she treats every conversation as a negotiation and every debt as leverage; beneath the courtesy is a cold patience that would rather wait a season than risk a misstep."},
