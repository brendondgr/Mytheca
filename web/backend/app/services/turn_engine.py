...
def run_turn(
    ...
    while beats < max_beats:
        ...
        yield from _generate_speaker(
            ...
            register=decision.register, stakes=decision.stakes, tracer=tracer,
        )
...
def _generate_speaker(
    ...
    *,
    ...
    before the planner has decided anything, so it carries no register and the prompt falls
    back to its generic "read the moment" cue.
